...
inline const uint32_t hash_32_fnv1a(std::string a_str)
{
	return hash_32_fnv1a(a_str.c_str(), a_str.length());
}
...
inline const uint32_t hash_64_fnv1a(std::string a_str)
{
	return hash_64_fnv1a(a_str.c_str(), a_str.length());
}
